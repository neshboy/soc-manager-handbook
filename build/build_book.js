...
const REPO_ROOT = "C:/Users/User/projects/soc-manager-handbook";
...
// "### Section X — Name" subheadings — same shape as the Detection Engineering Handbook's index.
function parseIndex() {
...
const TAG_COLORS = {
  CONCEPT: "tag-concept",
  "FRONTLINE MANAGER": "tag-frontline",
  "SENIOR MANAGER": "tag-senior",
  "HR/PEOPLE": "tag-hr",
  "VENDOR/PROCUREMENT": "tag-vendor",
...
function main() {
  ...
  * { box-sizing: border-box; }
  ...
  .tag-frontline { background: var(--aqua-tint); color: #0d6b49; border: 0.5pt solid var(--aqua); }
  .tag-senior { background: var(--blue-tint); color: #164a8a; border: 0.5pt solid var(--blue); }
  .tag-hr { background: var(--magenta-tint); color: #99245c; border: 0.5pt solid var(--magenta); }
  .tag-vendor { background: var(--violet-tint); color: #2e2470; border: 0.5pt solid var(--violet); }
  .tag-executive { background: var(--orange-tint); color: #93401d; border: 0.5pt solid var(--orange); }
  `;
...
<head>
<meta charset="utf-8">
<title>The SOC Manager's Operating Handbook</title>
<style>${css}</style>
</head>
<body>
<section class="cover">
  <div class="kicker">NESHBOY SOC Professional Library</div>
  <h1>THE SOC MANAGER'S OPERATING HANDBOOK</h1>
  <div class="accent-rule"></div>
  <h2>Staffing, Shift Design, Quality, Vendors, Budget, and Crisis Leadership — Running the Team, Not the Queue</h2>
